    ...
    <>
      <div className="">
            {props.hours && props.hours.reopenDate?
                <p className="font-evogriaregular text-2xl md:text-[18px]">Temp Closed</p>:props.hours?
                <p className="font-evogriaregular text-2xl md:text-[18px] closeing-div">&nbsp;{openClose.formatOpenNowString(props.hours, parsedOffset)}</p>:
                <p className="font-evogriaregular text-2xl md:text-[18px]">Closed</p>
            }
         </div>
    </>
  )
